...
\documentclass[
	...
	thesis={type=drfinal, dr=rernat, reviewer-on-uppertitleback=true},
...
\begin{document}
    ...
    \examdate{17.07.2023}
    \tuprints{urn=XXXXX,printid=XXXX,year=2024,license=cc-by-sa-4.0}% License information for TUprints
