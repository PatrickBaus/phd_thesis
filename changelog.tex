...
\begin{table}[h]
    ...
    \begin{tabularx}{0.95\textwidth}{ll>{\raggedright\arraybackslash}X}
        ...
        0.11.0 &2024-07-09 & Changed downsampling algorithm from decimation to LTTB. Affected files: dgDrive_supply_filter_bode.pgf, dgTemp_longterm.pgf, dgTemp_testmass.pgf, output_impedance_libbrecht_hall.pgf
    \end{tabularx}
\end{table}
