...
\begin{table}[h]
    ...
    \begin{tabularx}{0.95\textwidth}{lll}
        ...
        \hline
        0.9.0 &2023-05-10& Initial release submitted as the doctoral thesis
    \end{tabularx}
\end{table}
