...
\begin{document}
    \begin{circuitikz}[
        ...
        ;
        % boxes
        \node [draw=red!80!black, rectangle, dashed, fit=(RSnubber) (RSnubberlabel) (CSnubber) (CSnubberlabel)] (BoxSnubber){};
        \node [anchor=south west, align=left] at (BoxSnubber.south east) {Compensation network};
        \node [draw=red!80!black, rectangle, dashed, fit=(OA) (Rout) (Rfb)] (BoxBuffer){};
        \node [anchor=south, align=center] at (BoxBuffer.north) {Output protection buffer};
        \node [draw=red!80!black, rectangle, dashed, fit=(Cfilt1) (Cfilt2) (Cfilt2label) (Choke) (Chokelabel)] (BoxFilter){};
