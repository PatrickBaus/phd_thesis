    ...
    plots = [
        {
            "title": None,
            "show": True,
            #"zoom": ["2020-05-26 06:45:00", "2020-05-26 07:00:00",],
            "output_file": {
            ...
            "files": [
                {
                    ...
                    "filename": "011_neon_temperature_2016-11 00-00-00-26_2016-11-27 00-00-00.csv",  # Zener #15 vs. #1
                    "show": True,
                    "parser": "timescale_db_4",
                    "options": {
                        "labels": ["temperature",],
                        "scaling": {
